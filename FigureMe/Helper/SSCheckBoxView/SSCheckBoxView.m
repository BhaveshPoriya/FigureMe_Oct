...
static const CGFloat kHeight = 20.0f;
             ...
             checked:(BOOL)aChecked
{
    ...
    CGRect labelFrame = CGRectMake(20.0f, 0.0f, self.frame.size.width - 32, 15.0f);
    UILabel *l = [[UILabel alloc] initWithFrame:labelFrame];
    //l.textAlignment = UITextAlignmentLeft;
    l.backgroundColor = [UIColor clearColor];
    l.font = [UIFont fontWithName:@"OpenSans-Light" size:12];
    ...
    CGRect imageViewFrame = CGRectMake(3, 2, 12, 12);
                            ...
                            checked:(BOOL)isChecked
{
    ...
    NSString *imageName = @"new_cb_dark_";
